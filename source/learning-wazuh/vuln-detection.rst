  ...
  .. code-block:: json

    {
      ...
      "data": {
          ...
          "release": "3.11.0-693.17.1.el7.x86_64",
...
2. Query the OS information table
  ...
  .. code-block:: console
    ...
    1364535564|2018/02/23 01:11:23|linux-agent|x86_64|CentOS Linux|7 (Core)|||||centos|Linux|3.11.0-693.11.6.el7.x86_64|#1 SMP Thu Jan 4 01:06:37 UTC 2018
