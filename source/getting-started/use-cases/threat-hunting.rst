...
The **Management** module on the Wazuh dashboard presents both default and custom rules, covering a broad array of security events, including system anomalies, malware detection, authentication failures, and other potential threats as seen below.
...
The **Management** module on the Wazuh dashboard allows you to view default and custom **Decoders**. The image below shows details of the default decoder ``agent-upgrade``.
