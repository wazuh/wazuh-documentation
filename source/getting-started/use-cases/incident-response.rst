...
<<<<<<< HEAD:source/getting-started/use-cases/incident_response.rst
.. thumbnail:: ../../images/getting_started/use_case_active_response.png
   :title: A web attack trying to exploit a PHP server vulnerability
=======
.. thumbnail:: ../../images/getting-started/use-case-active-response.png
>>>>>>> origin/4.3-rc:source/getting-started/use-cases/incident-response.rst
   :align: center
   :wrap_image: No
