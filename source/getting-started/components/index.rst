...
- :ref:`Wazuh interface <wazuh_interface>`: Is a powerful user interface for data visualization and analysis. This interface is also used to manage Wazuh configuration and to monitor its status.
