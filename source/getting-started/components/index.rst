...
The Wazuh solution is based on the Wazuh agent, which is deployed on the monitored endpoints, and on three central components in charge of analyzing, processing, and storing the data: the Wazuh server, the Wazuh indexer, and the Wazuh dashboard.

- :doc:`Wazuh indexer <wazuh-indexer>`: It is a highly scalable, full-text search and analytics engine. This central component indexes and stores alerts generated by the Wazuh server. 
