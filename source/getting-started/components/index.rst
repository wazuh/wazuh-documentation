...
- :ref:`Wazuh indexer <wazuh_indexer>`: This is a highly scalable, full-text search and analytics engine. This central component indexes and stores alerts generated by the Wazuh server. 
- :ref:`Wazuh dashboard <wazuh_dashboard>`: It is a powerful user interface for data visualization and analysis. It is also used to manage Wazuh configuration and to monitor its status.
