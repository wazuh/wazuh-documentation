...
- :ref:`Wazuh indexer <wazuh_indexer>`: It indexes and stores alerts generated by the Wazuh server. 
- :ref:`Wazuh interface <wazuh_interface>`: A powerful user interface for data visualization and analysis. This interface is also used to manage Wazuh configuration and to monitor its status.
