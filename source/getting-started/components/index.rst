...
- :ref:`Wazuh indexer <wazuh_indexer>`: Is a highly scalable, full-text search and analytics engine. This central component indexes and stores alerts generated by the Wazuh server. 
- :ref:`Wazuh dashboard <wazuh_dashboard>`: Is a powerful user interface for data visualization and analysis. It is is also used to manage Wazuh configuration and to monitor its status.
