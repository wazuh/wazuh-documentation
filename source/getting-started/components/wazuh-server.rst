...
The Wazuh manager comprises several components listed below that have different functions, such as enrolling new Wazuh agents, validating the identity of each agent, and encrypting the communications between the Wazuh agent and the Wazuh manager.
...
To learn more, visit the :doc:`Wazuh manager API </user-manual/api/index>` documentation.
