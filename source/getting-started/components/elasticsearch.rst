...
Elasticsearch stores data as JSON documents. Each document correlates a set of keys, field names or properties, with their corresponding values that can be strings, numbers, Booleans, dates, arrays of values, geolocations, or other types of data.
