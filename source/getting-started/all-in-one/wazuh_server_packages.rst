...
This document will guide you to install the Wazuh server components in a all in one configuration. Please, check the :ref:`compatibility matrix<compatibility_matrix>` if you have any doubt about your OS compatibility.
