...
.. meta:: :description: Wazuh manager sources installation on Amazon Linux
...
This guide describes how to install the manager and API for Amazon Linux 1 or greater from source code. In addition, for multitier server, you will find some guidance on how to install Filebeat.
