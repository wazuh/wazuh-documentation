...
In the *Integrity monitoring* module of the Kibana, users can view all of the details of the alerts triggered and find a comprehensive summary of changes in files and registry keys. 
