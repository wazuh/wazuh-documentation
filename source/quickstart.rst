...
Wazuh central components can be installed on a 64-bit (x86_64/AMD64) Linux operating system. Wazuh recommends any of the following operating system versions:
