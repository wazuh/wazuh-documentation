...
Some calls to AWS services might fail when made in highly congested environments. The `Boto-3 <https://boto3.amazonaws.com/v1/documentation/api/latest/index.html>`__ client raises `ClientError`
