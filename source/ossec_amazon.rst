...
Before installing our Amazon rules, you need to follow the steps below to enable logging through AWS API and to download the JSON data files. A detailed description of each of the steps can be found further below. 
