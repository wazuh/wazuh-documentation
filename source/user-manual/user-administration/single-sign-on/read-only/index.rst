...
.. meta::
   :description: Wazuh can be integrated with several Identity Providers (IdP) to implement Single Sign-On (SSO). Learn how to setup SSO with read-only role in this section of the Wazuh documentation.
