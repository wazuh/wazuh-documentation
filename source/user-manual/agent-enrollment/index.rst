...
.. note::
      ...
      You can deploy a new agent from UI. Once you have a Wazuh installation running, open the Wazuh dashboard, go to **Wazuh** > **Agents**, and press the **Deploy new agent** button.
