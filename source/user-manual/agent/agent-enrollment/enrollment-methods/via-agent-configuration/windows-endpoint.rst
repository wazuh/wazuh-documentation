...
#. Select the “Endpopints Summary” module to check for the newly enrolled agent and its connection status in the Wazuh dashboard to confirm that enrollment was successful.
