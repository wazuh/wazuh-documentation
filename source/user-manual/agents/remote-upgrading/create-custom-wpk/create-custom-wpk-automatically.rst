...
Below, you will find an example of Linux WPK package building.
 ...
 .. code-block:: console
        ...
        # ./generate_wpk_package.sh -t linux -b v3.10.1 -d /tmp/wpk -k /tmp/keys -o LinuxAgent.wpk
...
To build a WPK for Windows you need to first download an MSI package of the desired version:
 ...
 .. code-block:: console
        ...
        # curl -O https://packages.wazuh.com/3.x/windows/wazuh-agent-3.10.1-1.msi

Below, you will find an example of Windows WPK package building.

 .. code-block:: console

        # ./generate_wpk_package.sh -t windows -b v3.10.1 -d /tmp/wpk -k /tmp/keys -o WindowsAgent.wpk -pd /tmp/wazuh-agent-3.10.1-1.msi
...
Here you can see an example of how to build a WPK generation with checksum:
 ...
 .. code-block:: console
        ...
        # ./generate_wpk_package.sh -t linux -b v3.10.1 -d /tmp/wpk -k /tmp/keys -o LinuxAgent.wpk -c /tmp/wpk_checksum
