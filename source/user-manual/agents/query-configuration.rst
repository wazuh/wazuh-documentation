...
The actual configuration of an agent, or the manager can be queried on demand by clicking on the **Endpoints Summary** module or the **Management** module. From here you will be able to fetch the active configuration in real time.
