...
Once an agent is installed on a machine to be monitored, it must be registered with the Wazuh Manager in order to establish communication. Take a look at :ref:`The registration process <registration-process>`.
