...
Log data collection is configured in the :ref:`agent.conf <reference_client_conf>` file primarily in the :ref:`localfile <reference_ossec_localfile>`, :ref:`remote <reference_ossec_remote>` and :ref:`global <reference_ossec_global>` sections. Configuration of log data collection can also be completed in the :ref:`shared.conf <reference_shared_conf>` file to centralize the distribution of these configuration settings to relevant agents.
