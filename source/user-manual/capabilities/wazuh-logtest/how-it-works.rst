...
If the session is preserved (adding the token field with the value of the token) and the same request 
is repeated 8 times, the alert generated is triggered by the rule with id 5712 of level 10.
