...
File integrity monitoring results for the whole environment can be observed in :ref:`Wazuh dashboard<kibana_app>` in the *Overview > Integrity monitoring* section:
