...
To adjust syscheck CPU usage on the monitored system, the :ref:`process_priority <reference_ossec_syscheck_process_priority>` option can be used. It sets the priority value for syscheck process. The default ``process_priority`` is set to 10.
