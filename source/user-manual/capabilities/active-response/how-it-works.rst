...
Active responses are configured in the manager. To do this, we must modify :ref:`ossec.conf <reference_ossec_conf>` file as follows:
...
The following scripts are for Windows:
