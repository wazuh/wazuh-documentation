...
Wazuh has a module that allows managing the Osquery tool from Wazuh agents to set the Osquery configuration. It collects the information generated by Osquery to send it to the manager, generating the corresponding alerts if necessary.
