...
- Only state changes and new checks are alerted to avoid alert flooding and repeated alerts in each scan, being those states updated in the manager database.
