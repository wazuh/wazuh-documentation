...
+------------------------+----------------------+---------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| max_request_per_minute | Any positive integer | 300           | The maximum number of requests per minute allowed for ingesting security events. The effective value is 30 for values greater than this limit. A value of 0 disables this feature. This setting only affects ``POST /events`` and doesn't consider authentication requests. If requests exceed this value in a minute, it blocks all incoming requests from any user for the remaining time.  |
+------------------------+----------------------+---------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
