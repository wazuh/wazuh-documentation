...
* The timeout can be disabled for all API requests with the parameter ``wait_for_complete``. This is useful for calls that could take more time than expected, such as :ref:`PUT/agents/:agent_id/upgrade <api_reference>`.
