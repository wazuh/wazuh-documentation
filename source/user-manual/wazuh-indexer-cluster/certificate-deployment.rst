...
.. note::
   ...
   -  If you already have a root CA generated during certificate creation for the :ref:`Wazuh server (all-in-one deployment) <server_nodes_certificate_creation_all_in_one>` or :ref:`Wazuh server (distributed deployment) <server_nodes_certificate_creation_distributed>` nodes.
