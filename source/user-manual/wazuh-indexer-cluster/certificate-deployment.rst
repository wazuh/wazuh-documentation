...
.. note::
   ...
   -  If you already have a root CA after generating certificates for the :doc:`Wazuh server </user-manual/wazuh-server-cluster/certificates-deployment>` or :doc:`Wazuh dashboard </user-manual/wazuh-dashboard/certificates>` nodes.
