...
|                    |                           |                    +--------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
|                    |                           |                    | alas         | Parameterized link to download the feed file from Wazuh's own repository for `Amazon Linux <https://feed.wazuh.com/vulnerability-detector/ALAS/1/alas.json.gz>`_ or `Amazon Linux 2 <https://feed.wazuh.com/vulnerability-detector/ALAS/2/alas2.json.gz>`_.               |
|                    |                           |                    |              | You can find a guide on how to set it up :doc:`here<../../capabilities/vulnerability-detection/offline_update>`.                                                                                                                                                          |
|                    |                           |                    +--------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
|                    |                           |                    +--------------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
|                    |                           |                    | alas         |  Path with regular expression that matches the feed file obtained from Wazuh's own repository for `Amazon Linux <https://feed.wazuh.com/vulnerability-detector/ALAS/1/alas.json.gz>`_ or                                                                                  |
