...
.. meta::
  :description: Osquery is an operating system monitoring and analytics framework. Check out more about the configuration options of the osquery wodle in this section. 
