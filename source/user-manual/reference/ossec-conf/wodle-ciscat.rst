...
.. warning::
    For this field, it can be set a full path or a relative path. Whether you specify a relative path, it concatenates with the Wazuh installation path. ``ciscat_path`` has the same behavior.
