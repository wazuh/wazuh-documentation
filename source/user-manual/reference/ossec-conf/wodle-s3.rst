...
- `bucket\\role_session_duration`_
- `bucket\\path`_
...
+----------------------------------+-------------------------------------------------------------+-----------------------------------------------+
| `bucket\\role_session_duration`_ | A number of seconds between 900 and 3600                    | Optional (if set, it requires an iam_role_arn |
|                                  |                                                             | to be provided)                               |
+----------------------------------+-------------------------------------------------------------+-----------------------------------------------+
...
bucket\\role_session_duration
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

A valid number of seconds that will define the duration of the session assumed using the provided :ref:`iam_role_arn<bucket_iam_role_arn>`.

+--------------------+-------------------------------+
| **Default value**  | N/A                           |
+--------------------+-------------------------------+
| **Allowed values** | Numbers between 900 and 3600  |
+--------------------+-------------------------------+
...
- `Service\\role_session_duration`_
...
Service\\role_session_duration
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

A valid number of seconds that will define the duration of the session assumed using the provided :ref:`iam_role_arn<service_iam_role_arn>`.
...
.. code-block:: xml
  ...
  <wodle name="aws-s3">
      ...
      <bucket type="custom">
          ...
          <role_session_duration>1300</role_session_duration>
