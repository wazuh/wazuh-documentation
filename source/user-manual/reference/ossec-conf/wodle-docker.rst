...
.. meta::
  :description: Learn about the wodle name="docker-listener" configuration section of ossec.conf, which configures monitoring of Docker container events.

.. _reference_ossec_wodle_docker:
