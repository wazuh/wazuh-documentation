...
You can specify remote commands in the :doc:`centralized configuration </user-manual/reference/centralized-configuration>`. However, they are disabled by default due to security reasons.
