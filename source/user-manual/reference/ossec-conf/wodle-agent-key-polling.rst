...
.. note:: Since 4.4.0, the agent-key-polling wodle is deprecated in favor of the :doc:`agent key request <../../registering/key-request>` feature. Although this configuration block is still usable, it is highly recommended to use its dedicated block in :doc:`auth <auth>`.
