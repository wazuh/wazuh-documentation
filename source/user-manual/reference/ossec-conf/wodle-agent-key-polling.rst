...
.. note:: Since v4.4.0, the agent-key-polling wodle is deprecated in favor of the :doc:`key-request <../../capabilities/key-request>` feature. Though this configuration block is still usable, it is much recommended to instead use its dedicated block in :doc:`auth <auth>`.
