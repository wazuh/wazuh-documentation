...
.. meta::
  :description: The cluster_control program allows you to manage the cluster from any manager. Learn more about it in this section of the Wazuh documentation.
