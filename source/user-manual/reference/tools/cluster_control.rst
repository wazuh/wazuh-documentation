...
* Get all connected nodes
    .. code-block:: shell
        ...
        worker-1  worker  3.11.1    172.17.0.101
        worker-2  worker  3.11.1    172.17.0.102
        master    master  3.11.1    172.17.0.100
...
* Get all agents
    .. code-block:: shell
        ...
        master  127.0.0.1  000  Active  Wazuh v3.11.1  master
        agent1  any        001  Active  Wazuh v3.11.1  worker-2
