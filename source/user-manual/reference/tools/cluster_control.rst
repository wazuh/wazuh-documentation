...
* Get all connected nodes
    .. code-block:: shell
        ...
        worker-1  worker  3.9.4    172.17.0.101
        worker-2  worker  3.9.4    172.17.0.102
        master    master  3.9.4    172.17.0.100
...
* Get all agents
    .. code-block:: shell
        ...
        master  127.0.0.1  000  Active  Wazuh v3.9.4  master
        agent1  any        001  Active  Wazuh v3.9.4  worker-2
