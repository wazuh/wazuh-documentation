     ...
     .. group-tab:: Yum
        ...
        * Registration with password:
        ...
        .. code-block:: console
             ...
             # WAZUH_MANAGER="10.0.0.2" WAZUH_REGISTRATION_PASSWORD="TopSecret" \
                  WAZUH_AGENT_NAME="yum-agent" yum install wazuh-agent-|WAZUH_CURRENT|-|WAZUH_REVISION_YUM_AGENT_X86|
        ...
        * Registration with password and assigning a group:
        ...
        .. code-block:: console
             ...
             # WAZUH_MANAGER="10.0.0.2" WAZUH_REGISTRATION_SERVER="10.0.0.2" WAZUH_REGISTRATION_PASSWORD="TopSecret" \
                  WAZUH_AGENT_GROUP="my-group" yum install wazuh-agent-|WAZUH_CURRENT|-|WAZUH_REVISION_YUM_AGENT_X86|
        ...
        * Registration with relative path to CA. It will be searched at your Wazuh installation folder:
        ...
        .. code-block:: console
             ...
             # WAZUH_MANAGER="10.0.0.2" WAZUH_REGISTRATION_SERVER="10.0.0.2" WAZUH_AGENT_NAME="yum-agent" \
                  WAZUH_REGISTRATION_CA="rootCA.pem" yum install wazuh-agent-|WAZUH_CURRENT|-|WAZUH_REVISION_YUM_AGENT_X86|
        ...
        * Registration with protocol:
        ...
        .. code-block:: console
             ...
             # WAZUH_MANAGER="10.0.0.2" WAZUH_REGISTRATION_SERVER="10.0.0.2" WAZUH_AGENT_NAME="yum-agent" \
                  WAZUH_PROTOCOL="udp" yum install wazuh-agent-|WAZUH_CURRENT|-|WAZUH_REVISION_YUM_AGENT_X86|
        ...
        * Absolute paths to CA, certificate or key that contain spaces can be written as shown below:
        ...
        .. code-block:: console
             ...
             # WAZUH_MANAGER="10.0.0.2" WAZUH_REGISTRATION_SERVER="10.0.0.2" WAZUH_REGISTRATION_KEY="/var/ossec/etc/sslagent.key" \
                  WAZUH_REGISTRATION_CERTIFICATE="/var/ossec/etc/sslagent.cert" yum install wazuh-agent-|WAZUH_CURRENT|-|WAZUH_REVISION_YUM_AGENT_X86|
     ...
     .. group-tab:: APT
        ...
        * Registration with password:
        ...
        .. code-block:: console
             ...
             # WAZUH_MANAGER="10.0.0.2" WAZUH_REGISTRATION_PASSWORD="TopSecret" \
                  WAZUH_AGENT_NAME="apt-agent" apt-get install wazuh-agent=|WAZUH_CURRENT|-|WAZUH_REVISION_DEB_AGENT_X86|
        ...
        * Registration with password and assigning a group:
        ...
        .. code-block:: console
             ...
             # WAZUH_MANAGER="10.0.0.2" WAZUH_REGISTRATION_SERVER="10.0.0.2" WAZUH_REGISTRATION_PASSWORD="TopSecret" \
                  WAZUH_AGENT_GROUP="my-group" apt-get install wazuh-agent=|WAZUH_CURRENT|-|WAZUH_REVISION_DEB_AGENT_X86|
        ...
        * Registration with relative path to CA. It will be searched at your Wazuh installation folder:
        ...
        .. code-block:: console
             ...
             # WAZUH_MANAGER="10.0.0.2" WAZUH_REGISTRATION_SERVER="10.0.0.2" WAZUH_AGENT_NAME="apt-agent" \
                  WAZUH_REGISTRATION_CA="rootCA.pem" apt-get install wazuh-agent=|WAZUH_CURRENT|-|WAZUH_REVISION_DEB_AGENT_X86|
        ...
        * Registration with protocol:
        ...
        .. code-block:: console
             ...
             # WAZUH_MANAGER="10.0.0.2" WAZUH_REGISTRATION_SERVER="10.0.0.2" WAZUH_AGENT_NAME="apt-agent" \
                  WAZUH_PROTOCOL="udp" apt-get install wazuh-agent=|WAZUH_CURRENT|-|WAZUH_REVISION_DEB_AGENT_X86|
        ...
        * Absolute paths to CA, certificate or key that contain spaces can be written as shown below:
        ...
        .. code-block:: console
             ...
             # WAZUH_MANAGER="10.0.0.2" WAZUH_REGISTRATION_SERVER="10.0.0.2" WAZUH_REGISTRATION_KEY="/var/ossec/etc/sslagent.key" \
                  WAZUH_REGISTRATION_CERTIFICATE="/var/ossec/etc/sslagent.cert" apt-get install wazuh-agent=|WAZUH_CURRENT|-|WAZUH_REVISION_DEB_AGENT_X86|
     ...
     .. group-tab:: ZYpp
        ...
        * Registration with password:
        ...
        .. code-block:: console
             ...
             # WAZUH_MANAGER="10.0.0.2" WAZUH_REGISTRATION_PASSWORD="TopSecret" \
                  WAZUH_AGENT_NAME="zypper-agent" zypper install wazuh-agent-|WAZUH_CURRENT|-|WAZUH_REVISION_YUM_AGENT_X86|
        ...
        * Registration with password and assigning a group:
        ...
        .. code-block:: console
             ...
             # WAZUH_MANAGER="10.0.0.2" WAZUH_REGISTRATION_SERVER="10.0.0.2" WAZUH_REGISTRATION_PASSWORD="TopSecret" \
                  WAZUH_AGENT_GROUP="my-group" zypper install wazuh-agent-|WAZUH_CURRENT|-|WAZUH_REVISION_YUM_AGENT_X86|
        ...
        * Registration with relative path to CA. It will be searched at your Wazuh installation folder:
        ...
        .. code-block:: console
             ...
             # WAZUH_MANAGER="10.0.0.2" WAZUH_REGISTRATION_SERVER="10.0.0.2" WAZUH_AGENT_NAME="zypper-agent" \
                  WAZUH_REGISTRATION_CA="rootCA.pem" zypper install wazuh-agent-|WAZUH_CURRENT|-|WAZUH_REVISION_YUM_AGENT_X86|
        ...
        * Registration with protocol:
        ...
        .. code-block:: console
             ...
             # WAZUH_MANAGER="10.0.0.2" WAZUH_REGISTRATION_SERVER="10.0.0.2" WAZUH_AGENT_NAME="zypper-agent" \
                  WAZUH_PROTOCOL="udp" zypper install wazuh-agent-|WAZUH_CURRENT|-|WAZUH_REVISION_YUM_AGENT_X86|
        ...
        * Absolute paths to CA, certificate or key that contain spaces can be written as shown below:
        ...
        .. code-block:: console
             ...
             # WAZUH_MANAGER="10.0.0.2" WAZUH_REGISTRATION_SERVER="10.0.0.2" WAZUH_REGISTRATION_KEY="/var/ossec/etc/sslagent.key" \
                  WAZUH_REGISTRATION_CERTIFICATE="/var/ossec/etc/sslagent.cert" zypper install wazuh-agent-|WAZUH_CURRENT|-|WAZUH_REVISION_YUM_AGENT_X86|
