...
.. meta::
  :description: The Wazuh Kibana plugin allows users to view and analyze Wazuh alerts stored in Elasticsearch. Learn more about it in the Wazuh documentation
