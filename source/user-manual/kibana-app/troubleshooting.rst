...
.. code-block:: console
  ...
  # curl https://raw.githubusercontent.com/wazuh/wazuh/v3.11.1/extensions/elasticsearch/7.x/wazuh-template.json | curl -X PUT "http://localhost:9200/_template/wazuh" -H 'Content-Type: application/json' -d @-
...
You can't use the 3.7.2 version of Wazuh API with a Wazuh app designed for Wazuh 3.11.1.
