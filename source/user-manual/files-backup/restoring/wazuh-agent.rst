...
#. Compress the files generated after performing the :doc:`Wazuh files backup </user-manual/files-backup/creating/wazuh-agent>` and transfer them to the respective monitored endpoints.
...
2. Using the Wazuh dashboard, navigate to **Active agents**. Select your Wazuh agent to see the data from the backup, such as **Security events**, **Vulnerabilities**, **Configuration assessment**, and others.
