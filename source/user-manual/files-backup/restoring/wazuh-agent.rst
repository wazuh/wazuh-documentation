...
2. Using the Wazuh dashboard, navigate to **Active agents**. Select your Wazuh agent to see the data from the backup, such as **Threat hunting**, **Vulnerabilities**, **Configuration assessment**, and others.
