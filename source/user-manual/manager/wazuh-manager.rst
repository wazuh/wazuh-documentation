...
-  **Custom logs**: You can configure  Wazuh to collect and parse logs from several applications and third-party security tools, including :doc:`Windows Defender </user-manual/capabilities/malware-detection/win-defender-logs-collection>`, :doc:`ClamAV </user-manual/capabilities/malware-detection/clam-av-logs-collection>`, and more.
