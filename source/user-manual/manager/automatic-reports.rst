...
Daily reports are summaries of the alerts that were triggered each day. You can configure your own customized report by using the ``report`` option in the ``manager.conf`` file. See the :ref:`report <reference_ossec_reports>` documentation to learn more. 
