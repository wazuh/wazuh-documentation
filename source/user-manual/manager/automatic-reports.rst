...
A preview of a report may be generated by piping the contents of the `alerts.log` file to `wazuh-reportd` daemon:
::

 cat /var/ossec/logs/alerts/alerts.log | /var/ossec/bin/wazuh-reportd -n "Daily report: Alerts with level higher than 10" -s -f level  10 2> report-test.txt
