...
.. meta::
  :description: Check out how to register the Wazuh agents using the Wazuh API, that allows the Wazuh agent registration by running a single request from any host.
