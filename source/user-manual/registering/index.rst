...
+------------------------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| :ref:`Using Wazuh API manually <restful-api-register>`                                         | Requires Wazuh API user name and password. Doesn't require root access to a manager.                                                                                             |
+------------------------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| :ref:`Using scripts to register agents with API <restful-api-register-script>`                 | Fast and easy way to register agents for those familiar with using scripts. Available for Linux/Unix and for Windows hosts.                                                      |
+------------------------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
| :ref:`Using simple registration service <simple-registration-service>`                         | The easiest registration method. Requires Root/Administrator access to an agent. Doesn't require an access to a manager. Allows to add an agent to a group during registration.  |
+------------------------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
