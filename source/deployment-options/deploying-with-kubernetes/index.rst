...
In this section of the documentation you will see how to clone the `Wazuh Kubernetes repository <https://github.com/wazuh/wazuh-kubernetes>`_, setup certificates, apply the manifests, and deploy the necessary pods and services for installing Wazuh on Kubernetes. You will also learn to make an upgrade to your implementation. Finally, you will see how to clean up both cluster and volumes.
