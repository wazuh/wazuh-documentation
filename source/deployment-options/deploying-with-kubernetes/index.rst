...
In this section of the documentation, you will see how to clone the `Wazuh Kubernetes repository <https://github.com/wazuh/wazuh-kubernetes>`_, set up certificates, apply the manifests, and deploy the necessary pods and services for installing Wazuh on Kubernetes in the cloud and a local environments. In addition, you will find :doc:`/deployment-options/deploying-with-kubernetes/kubernetes-conf` and :doc:`/deployment-options/deploying-with-kubernetes/kubernetes-local-env` subsections, and you will learn to upgrade your implementation in the :doc:`/deployment-options/deploying-with-kubernetes/kubernetes-upgrade` subsection. Finally, you will see how to clean up both clusters and volumes in the :doc:`/deployment-options/deploying-with-kubernetes/kubernetes-clean-up` subsection.
