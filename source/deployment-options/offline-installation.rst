    ...
    .. tabs::
        ...
        .. group-tab:: DEB
            ...
            .. code-block:: console
                ...
                # cat ./wazuh-offline/wazuh-files/GPG-KEY-WAZUH | gpg --no-default-keyring --keyring gnupg-ring:/etc/apt/trusted.gpg.d/GPG-KEY-WAZUH.gpg --import && chmod 644 /etc/apt/trusted.gpg.d/GPG-KEY-WAZUH.gpg
