...
.. note::
   ...
   You can access the Wazuh dashboard directly using the URL ``https://<CLOUD_ID>.cloud.wazuh.com``, where ``<CLOUD_ID>`` is the Cloud ID of your environment. If you have any questions about the Wazuh Cloud, see the :doc:`Cloud service FAQ <starting-faq>`.

Next steps
----------

Your Wazuh Cloud environment is ready, and you can install the Wazuh agent on the endpoints you want to monitor. See the :doc:`Enroll agents <enroll-agents>` section to learn how to install agents.