...
custom_replacements = {
    "|WAZUH_LATEST|" : "3.1.0",
    "|WAZUH_LATEST_MINOR|" : "3.1",
    "|WAZUH_LATEST_ANSIBLE|" : "3.1.0",
    "|WAZUH_LATEST_KUBERNETES|" : "3.1.0",
    "|WAZUH_LATEST_PUPPET|" : "3.1.0",
    "|WAZUH_LATEST_OVA|" : "3.1.0",
    "|WAZUH_LATEST_DOCKER|" : "3.1.0",
    "|ELASTICSEARCH_LATEST|" : "6.1.3",
    "|ELASTICSEARCH_LATEST_OVA|" : "6.1.1",
    "|ELASTICSEARCH_LATEST_ANSIBLE|" : "6.1.3",
    "|ELASTICSEARCH_LATEST_KUBERNETES|" : "6.1.3",
    "|ELASTICSEARCH_LATEST_PUPPET|" : "6.1.3",
    "|ELASTICSEARCH_LATEST_DOCKER|" : "6.1.3",
    "|ELASTIC_6_LATEST|" : "6.1.3",
