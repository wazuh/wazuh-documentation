...
custom_replacements = {
    "|WAZUH_LATEST|" : "3.8.2",
    "|WAZUH_LATEST_MINOR|" : "3.8",
    "|WAZUH_LATEST_ANSIBLE|" : "3.8.2",
    "|WAZUH_LATEST_KUBERNETES|" : "3.8.2",
    "|WAZUH_LATEST_PUPPET|" : "3.8.2",
    "|WAZUH_LATEST_OVA|" : "3.8.2",
    "|WAZUH_LATEST_DOCKER|" : "3.8.2",
    "|ELASTICSEARCH_LATEST|" : "6.7.1",
    "|ELASTICSEARCH_LATEST_OVA|" : "6.7.0",
    "|ELASTICSEARCH_LATEST_ANSIBLE|" : "6.7.1",
    "|ELASTICSEARCH_LATEST_KUBERNETES|" : "6.7.1",
    "|ELASTICSEARCH_LATEST_PUPPET|" : "6.7.1",
    "|ELASTICSEARCH_LATEST_DOCKER|" : "6.7.1",
    "|SPLUNK_LATEST|" : "7.2.5",
    "|ELASTIC_6_LATEST|" : "6.7.1",
