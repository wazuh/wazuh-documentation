...
custom_replacements = {
    "|WAZUH_LATEST|" : "3.4.0",
    "|WAZUH_LATEST_MINOR|" : "3.4",
    "|WAZUH_LATEST_ANSIBLE|" : "3.4.0",
    "|WAZUH_LATEST_KUBERNETES|" : "3.4.0",
    "|WAZUH_LATEST_PUPPET|" : "3.4.0",
    "|WAZUH_LATEST_OVA|" : "3.4.0",
    "|WAZUH_LATEST_DOCKER|" : "3.4.0",
    "|ELASTICSEARCH_LATEST|" : "6.3.2",
    "|ELASTICSEARCH_LATEST_OVA|" : "6.3.1",
    "|ELASTICSEARCH_LATEST_ANSIBLE|" : "6.3.2",
    "|ELASTICSEARCH_LATEST_KUBERNETES|" : "6.3.2",
    "|ELASTICSEARCH_LATEST_PUPPET|" : "6.3.2",
    "|ELASTICSEARCH_LATEST_DOCKER|" : "6.3.2",
    "|SPLUNK_LATEST|" : "7.1.2",
    "|ELASTIC_6_LATEST|" : "6.3.2",
