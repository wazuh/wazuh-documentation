...
custom_replacements = {
    "|WAZUH_LATEST|" : "3.6.1",
    "|WAZUH_LATEST_MINOR|" : "3.6",
    "|WAZUH_LATEST_ANSIBLE|" : "3.6.1",
    "|WAZUH_LATEST_KUBERNETES|" : "3.6.1",
    "|WAZUH_LATEST_PUPPET|" : "3.6.1",
    "|WAZUH_LATEST_OVA|" : "3.6.1",
    "|WAZUH_LATEST_DOCKER|" : "3.6.1",
    "|ELASTICSEARCH_LATEST|" : "6.4.3",
    "|ELASTICSEARCH_LATEST_OVA|" : "6.4.0",
    "|ELASTICSEARCH_LATEST_ANSIBLE|" : "6.4.3",
    "|ELASTICSEARCH_LATEST_KUBERNETES|" : "6.4.3",
    "|ELASTICSEARCH_LATEST_PUPPET|" : "6.4.3",
    "|ELASTICSEARCH_LATEST_DOCKER|" : "6.4.3",
    "|SPLUNK_LATEST|" : "6.7.1",
    "|ELASTIC_6_LATEST|" : "6.4.3",
