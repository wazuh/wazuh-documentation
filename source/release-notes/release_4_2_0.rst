...
`#8151 <https://github.com/wazuh/wazuh/pull/8151>`_                                                                  A starving hazard issue in the Wazuh database is fixed and there are no longer risks of incoming requests being stalled during database commitment.
...
`#8905 <https://github.com/wazuh/wazuh/pull/8905>`_                                                                  This fix in the agent on Windows resolves the issue that might cause the FIM database to be corrupted when disabling the disk sync.
=================================================================================================================    =============
