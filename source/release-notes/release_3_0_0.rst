...
The procedure for using the MSI installer can be found at: :doc:`Install Wazuh agent on Windows <../../installation-guide/installing-wazuh-agent/wazuh_agent_packages_windows>`
