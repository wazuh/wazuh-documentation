...
- `#19819 <https://github.com/wazuh/wazuh/pull/19819>`__ Replaced Filebeat date index name processor.
...
- `#6093 <https://github.com/wazuh/wazuh-dashboard-plugins/pull/6093>`__ Added update availability checking and notification to the UI.
...
- `#5840 <https://github.com/wazuh/wazuh-dashboard-plugins/pull/5840>`__ Added an agent selector to the IT Hygiene application.
- `#5840 <https://github.com/wazuh/wazuh-dashboard-plugins/pull/5840>`__ Moved the plugin menu to platform applications into the side menu.
...
- `#6035 <https://github.com/wazuh/wazuh-dashboard-plugins/pull/6035>`__ Updated dashboards.
- `#6067 <https://github.com/wazuh/wazuh-dashboard-plugins/pull/6067>`__ Change the display order of tabs in all modules.
