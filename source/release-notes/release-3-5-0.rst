...
In addition to this, the documentation now has a dedicated section for the Wazuh Dashboard, where you can learn more about its capabilities, how to configure it and install the X-Pack Security plugin.
