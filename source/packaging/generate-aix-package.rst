...
This will generate a 3.11.1 Wazuh agent AIX package.

.. code-block:: console

  # ./generate_wazuh_packages.sh -b v3.11.1 -c

This will generate a 3.11.1 Wazuh agent AIX package with checksum.

.. code-block:: console

  # ./generate_wazuh_packages.sh -b v3.11.1  -p /opt

This will generate a 3.11.1 Wazuh agent AIX package with ``/opt`` as installation directory.