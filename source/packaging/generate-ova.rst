...
.. code-block:: console
  ...
  # ./generate_ova.sh -b -v 3.11.2 -e 7.4.0 -r stable

This will generate a Virtual machine with Wazuh manager 3.11.2 and ELK 7.4.0 installed using stable packages

.. code-block:: console

  # ./generate_ova.sh -b -v 3.11.2 -e 7.4.0 -r unstable -c

This will generate a Virtual machine with Wazuh manager 3.11.2 and ELK 7.4.0 installed using unstable packages and generate the sha512 checksum
