...
The migration of Elastic Stack, in the case that you already have it installed, is beyond the scope of Wazuh documentation. For a default Wazuh installation read :doc:`/installation-guide/index`.
