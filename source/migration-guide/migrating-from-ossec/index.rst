...
The migration of Elastic Stack, in the case that you already have it installed, is beyond the scope of Wazuh documentation. To learn more about the default Wazuh installation, see the :doc:`/installation-guide/index`.
