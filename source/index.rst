...
.. thumbnail:: images/screenshots/ag-welcome.png
   :title: Summary including all alerts generated by the agent Ubuntu (003) during the last hour.
   :class: d-block w-100
...
.. thumbnail:: images/screenshots/discover.png
   :title: Interactive screen showing every event occurred within the last 7 days.
   :class: d-block w-100
...
.. thumbnail:: images/screenshots/ow-fim.png
   :title: Summary graphs showing the file integrity related alerts occurred in the whole system during the last 30 days.
   :class: d-block w-100
