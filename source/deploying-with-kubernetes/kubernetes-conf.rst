...
| Image                   | Controller  |
+=========================+=============+
| wazuh/wazuh:3.8.2_6.7.0 | StatefulSet |
+-------------------------+-------------+
...
| Image                                 | Controller  |
+=======================================+=============+
| wazuh/wazuh-elasticsearch:3.8.2_6.7.0 | StatefulSet |
+---------------------------------------+-------------+
...
| Image                            | Controller  |
+==================================+=============+
| wazuh/wazuh-logstash:3.8.2_6.7.0 | Deployment  |
+----------------------------------+-------------+
...
| Image                          | Controller  |
+================================+=============+
| wazuh/wazuh-kibana:3.8.2_6.7.0 | Deployment  |
+--------------------------------+-------------+
...
| Image                          | Controller  |
+================================+=============+
| wazuh/wazuh-nginx:3.8.2_6.7.0  | Deployment  |
+--------------------------------+-------------+
