...
| Image                    | Controller  |
+==========================+=============+
| wazuh/wazuh:3.11.0_7.5.1 | StatefulSet |
+--------------------------+-------------+
...
| Image                                  | Controller  |
+========================================+=============+
| wazuh/wazuh-elasticsearch:3.11.0_7.5.1 | StatefulSet |
+----------------------------------------+-------------+
...
| Image                             | Controller  |
+===================================+=============+
| wazuh/wazuh-logstash:3.11.0_7.5.1 | Deployment  |
+-----------------------------------+-------------+
...
| Image                           | Controller  |
+=================================+=============+
| wazuh/wazuh-kibana:3.11.0_7.5.1 | Deployment  |
+---------------------------------+-------------+
...
| Image                           | Controller  |
+=================================+=============+
| wazuh/wazuh-nginx:3.11.0_7.5.1  | Deployment  |
+---------------------------------+-------------+
