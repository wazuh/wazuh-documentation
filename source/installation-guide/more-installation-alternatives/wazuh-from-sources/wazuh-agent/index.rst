...
.. tabs::
  ...
  .. group-tab:: Linux
    ...
    If you need to uninstall a Wazuh agent installed from sources you may follow the instructions in this :ref:`section <uninstalling_wazuh_agents_from_sources_linux>`. 
  ...
  .. group-tab:: Windows
    ...
    If you need to uninstall a Wazuh agent installed from sources you may follow the instructions in this :ref:`section <uninstalling_wazuh_agents_from_sources_windows>`.
  ...
  .. group-tab:: macOS
    ...
    If you need to uninstall a Wazuh agent installed from sources you may follow the instructions in this :ref:`section <uninstalling_wazuh_agents_from_sources_macos>`.
  ...
  .. group-tab:: AIX
    ...
    If you need to uninstall a Wazuh agent installed from sources you may follow the instructions in this :ref:`section <uninstalling_wazuh_agents_from_sources_aix>`.
  ...
  .. group-tab:: Solaris
    ...
    .. tabs::
      ...
      .. tab:: Solaris 11
        ...
        If you need to uninstall a Wazuh agent installed from sources you may follow the instructions in this :ref:`section <uninstalling_wazuh_agents_from_sources_solaris>`.
  ...
  .. group-tab:: HP-UX
    ...
    If you need to uninstall a Wazuh agent installed from sources you may follow the instructions in this :ref:`section <uninstalling_wazuh_agents_from_sources_hpux>`.
