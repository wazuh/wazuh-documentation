  ...
  .. group-tab:: Single-node
    ...
    **Download the script and the configuration file config.yml**
      ...
      .. code-block:: console
          ...
          # curl -so ~/elastic-stack-installation.sh https://documentation.wazuh.com/4.1/resources/elastic-stack/unattended-installation/distributed/elastic-stack-installation.sh 
          # curl -so ~/config.yml https://documentation.wazuh.com/4.1/resources/elastic-stack/unattended-installation/distributed/templates/config.yml
  ...
  .. group-tab:: Multi-node
    ...
    **Initial node configuration and installation**
      ...
      .. code-block:: console
          ...
          # curl -so ~/elastic-stack-installation.sh https://documentation.wazuh.com/4.1/resources/elastic-stack/unattended-installation/distributed/elastic-stack-installation.sh 
          # curl -so ~/config.yml https://documentation.wazuh.com/4.1/resources/elastic-stack/unattended-installation/distributed/templates/config_cluster.yml
