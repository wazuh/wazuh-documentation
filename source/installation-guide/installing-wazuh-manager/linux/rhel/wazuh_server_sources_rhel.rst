...
Install Wazuh server on Red Hat Enterprise Linux from sources
=============================================================
...
the process is more complex than you may like and it is beyond the scope of Wazuh documentation. We recommend :ref:`installing Filebeat via repository package  <wazuh_server_rpm_rhel_filebeat>`.
