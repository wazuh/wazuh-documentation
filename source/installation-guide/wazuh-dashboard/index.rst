...
Wazuh dashboard can be installed on a 64-bit Linux operating system with Intel/AMD64 architecture. Wazuh supports the following operating system versions:
