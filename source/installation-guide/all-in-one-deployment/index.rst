...
- The Wazuh server including the Wazuh manager in a single-node cluster, the Wazuh API and the Wazuh Kibana plugin.

- Elastic Stack including Filebeat, Open Distro for Elasticesearch in a single-node cluster and Kibana.
