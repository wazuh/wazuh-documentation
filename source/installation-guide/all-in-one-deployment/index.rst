...
This section guides through the installation and configuration of the Wazuh server and Elastic Stack in the same host. This type of deployment is appropriate for testing and small production environments.

The following components will be installed:

- The Wazuh server, including the Wazuh manager as a single-node cluster, the Wazuh API and the Wazuh Kibana plugin.

- Elastic Stack, including Filebeat, Open Distro for Elasticesearch as a single-node cluster and Kibana.
