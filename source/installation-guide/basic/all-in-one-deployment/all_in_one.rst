...
#. Download the configuration file for creating the certificates:
    ...
    .. code-block:: console
        ...
        # curl -so /usr/share/elasticsearch/instances.yml https://raw.githubusercontent.com/wazuh/wazuh-documentation/2205-Open_Distro_installation/resources/elastic-stack/instances_aio.yml
...
#. Download the pre-configured Filebeat config file used to forward Wazuh alerts to Elasticsearch:
    ...
    .. code-block:: console
      ...
      # curl -so /etc/filebeat/filebeat.yml https://raw.githubusercontent.com/wazuh/wazuh-documentation/2205-Open_Distro_installation/resources/elastic-stack/filebeat/7.x/filebeat_all_in_one.yml
