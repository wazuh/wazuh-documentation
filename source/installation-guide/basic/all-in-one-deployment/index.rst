...
The communication will be encrypted using SSL certificates. The guide will refer to the section explaining how to secure communication between the Wazuh API and the Wazuh Kibana plugin.
