...
.. code-block:: console
    ...
    # curl -so ~/all-in-one-installation.sh https://documentation.wazuh.com/resources/open-distro/unattended-installation/all-in-one-installation.sh && bash ~/all-in-one-installation.sh
