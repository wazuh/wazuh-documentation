...
As an alternative to this installation method, you can download the Wazuh agent package directly. To perform this action, see the :ref:`Package list <packages>` section. 
