...
.. code-block:: console
    ...
    # curl -so ~/wazuh-server-installation.sh https://documentation.wazuh.com/4.1/resources/open-distro/unattended-installation/distributed/wazuh-server-installation.sh 
