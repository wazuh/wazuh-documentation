...
.. code-block:: console
    ...
    # curl -so ~/wazuh-server-installation.sh https://documentation.wazuh.com/resources/open-distro/unattended-installation/distributed/wazuh-server-installation.sh 
