...
To guarantee the expected performance of the Wazuh and Elastic Stack components all hosts must meet the hardware requirements described in the :ref:`requirements <distributed_requirements>` section.
