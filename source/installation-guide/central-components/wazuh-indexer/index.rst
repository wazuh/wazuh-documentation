...
- Disk space requirements
  ...
  For example, for an environment with 80 workstations, 10 servers, and 10 network devices, the storage needed on the Wazuh indexer for 90 days of alerts is 230 GB. 
