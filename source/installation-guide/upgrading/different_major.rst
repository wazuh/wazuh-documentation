...
1. Update Elasticsearch:
  ...
  a) For CentOS/RHEL/Fedora:
    ...
    .. code-block:: console
      ...
      # yum install elasticsearch-6.7.0
  ...
  b) For Debian/Ubuntu:
    ...
    .. code-block:: console
      ...
      # apt-get update
      # apt-get install elasticsearch=6.7.0
...
1. Upgrade Logstash:
  ...
  a) For CentOS/RHEL/Fedora:
    ...
    .. code-block:: console
      ...
      # yum install logstash-6.7.0

  b) For Debian/Ubuntu:

    .. code-block:: console

      # apt-get install logstash=1:6.7.0-1
...
1. Upgrade Kibana:
  ...
  a) For CentOS/RHEL/Fedora:
    ...
    .. code-block:: console
      ...
      # yum install kibana-6.7.0

  b) For Debian/Ubuntu:

    .. code-block:: console

      # apt-get install kibana=6.7.0
...
4. Upgrade the Wazuh Kibana App:
  ...
  .. code-block:: console
      ...
      # su -c 'NODE_OPTIONS="--max-old-space-size=3072" /usr/share/kibana/bin/kibana-plugin install https://packages.wazuh.com/wazuhapp/wazuhapp-3.8.2_6.7.0.zip' kibana
