...
.. |macOS_intel_64| replace:: `wazuh-agent-|WAZUH_CURRENT_OSX|-|WAZUH_REVISION_OSX|.intel64.pkg <https://packages-staging.xdrsiem.wazuh.info/nightly/5.0.0/macos/wazuh-agent-5.0.0-latest.intel64.pkg>`__
.. |macOS_arm64| replace:: `wazuh-agent-|WAZUH_CURRENT_OSX|-|WAZUH_REVISION_OSX|.arm64.pkg <https://packages-staging.xdrsiem.wazuh.info/nightly/5.0.0/macos/wazuh-agent-5.0.0-latest.arm64.pkg>`__
