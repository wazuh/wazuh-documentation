        ...
        .. tabs::
          ...
          .. group-tab:: CLI
             ...
             -  Using PowerShell:
              ...
              For additional deployment options such as agent name, agent group, and registration password, see the :doc:`Deployment variables for Windows </user-manual/agent/deployment-variables/deployment-variables-windows>` section.
