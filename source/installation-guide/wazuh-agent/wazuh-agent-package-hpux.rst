...
#. To start the installation process, download the `HP-UX installer <https://packages.wazuh.com/|WAZUH_CURRENT_MAJOR|/hp-ux/wazuh-agent-|WAZUH_CURRENT|-|WAZUH_REVISION_HPUX|-hpux-11v3-ia64.tar>`_. 
