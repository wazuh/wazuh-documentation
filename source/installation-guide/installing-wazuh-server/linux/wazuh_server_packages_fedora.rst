...
.. meta:: :description: Learn how to install Wazuh manager on Fedora
...
To install the Wazuh server components on Fedora 22 or higher versions, you have to install the relevant packages after you've added the repositories.
