...
.. meta:: :description: Learn how to install Wazuh manager on Red Hat Enterprise Linux
...
To install the Wazuh server components on Red Hat Enterprise Linux 6 or higher versions, you have to install the relevant packages after you've added the repositories.
