...
4. Upgrade the node you shut down.
  ...
  * For Debian/Ubuntu:
    ...
    .. code-block:: console
      ...
      # apt-get install elasticsearch=6.8.0
...
10. Load the Wazuh template for Elasticsearch:
  ...
  .. code-block:: console
    ...
    # curl https://raw.githubusercontent.com/wazuh/wazuh/v3.9.2/extensions/elasticsearch/6.x/wazuh-template.json | curl -X PUT "http://localhost:9200/_template/wazuh" -H 'Content-Type: application/json' -d @-
...
1. Upgrade the ``logstash`` package:
  ...
  .. code-block:: console
    ...
    # yum install logstash-6.8.0

  b) For Debian/Ubuntu:

  .. code-block:: console

    # apt-get install logstash=1:6.8.0-1
...
2. Download and set the Wazuh configuration for Logstash:
  ...
  a) Local configuration:
    ...
    .. code-block:: console
      ...
      # curl -so /etc/logstash/conf.d/01-wazuh.conf https://raw.githubusercontent.com/wazuh/wazuh/v3.9.2/extensions/logstash/6.x/01-wazuh-local.conf
...
1. Upgrade Filebeat.
  ...
  * For CentOS/RHEL/Fedora:
    ...
    .. code-block:: console
      ...
      # yum install filebeat-6.8.0

  * For Debian/Ubuntu:

    .. code-block:: console

      # apt-get install filebeat=6.8.0
...
2. Update the configuration file.
  ...
  .. code-block:: console
    ...
    # curl -so /etc/filebeat/filebeat.yml https://raw.githubusercontent.com/wazuh/wazuh/v3.9.2/extensions/filebeat/6.x/filebeat.yml
...
1. Upgrade the ``kibana`` package:
  ...
  .. code-block:: console
    ...
    # yum install kibana-6.8.0

  b) For Debian/Ubuntu:

  .. code-block:: console

    # apt-get install kibana=6.8.0
...
3. Upgrade the Wazuh app:
  ...
  .. code-block:: console
    ...
    # sudo -u kibana NODE_OPTIONS="--max-old-space-size=3072" /usr/share/kibana/bin/kibana-plugin install https://packages.wazuh.com/wazuhapp/wazuhapp-3.9.2_6.8.0.zip
