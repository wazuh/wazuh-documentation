...
2. Download and set the Wazuh configuration for Logstash:
  ...
  a) Local configuration:
    ...
    .. code-block:: console
      ...
      # curl -so /etc/logstash/conf.d/01-wazuh.conf https://raw.githubusercontent.com/wazuh/wazuh/v3.9.1/extensions/logstash/6.x/01-wazuh-local.conf
...
3. Upgrade the Wazuh app:
  ...
  .. code-block:: console
    ...
    # sudo -u kibana NODE_OPTIONS="--max-old-space-size=3072" /usr/share/kibana/bin/kibana-plugin install https://packages.wazuh.com/wazuhapp/wazuhapp-3.9.1_6.8.0.zip
