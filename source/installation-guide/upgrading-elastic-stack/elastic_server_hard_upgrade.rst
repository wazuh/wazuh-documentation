...
2. Download and set the Wazuh configuration for Logstash:
  ...
  a) Local configuration:
    ...
    .. code-block:: console
      ...
      # curl -so /etc/logstash/conf.d/01-wazuh.conf https://raw.githubusercontent.com/wazuh/wazuh/v3.9.0/extensions/logstash/6.x/01-wazuh-local.conf
  ...
  b) Remote configuration:
    ...
    .. code-block:: console
      ...
      # cp /etc/logstash/conf.d/01-wazuh.conf /backup_directory/01-wazuh.conf.bak
      # curl -so /etc/logstash/conf.d/01-wazuh.conf https://raw.githubusercontent.com/wazuh/wazuh/v3.9.0/extensions/logstash/6.x/01-wazuh-remote.conf
...
2. Update the configuration file.
  ...
  .. code-block:: console
    ...
    # curl -so /etc/filebeat/filebeat.yml https://raw.githubusercontent.com/wazuh/wazuh/v3.9.0/extensions/filebeat/6.x/filebeat.yml
