...
1. This virtual appliance, available `here <https://packages.wazuh.com/vm/wazuh3.8.0_6.5.4.ova>`_, contains the following components:
...
.. note:: You can also download the virtual machine using the OVF format. You need to download the `OVF <https://packages.wazuh.com/vm/wazuh3.8.0_6.5.4.ovf>`_ file and the `vmdk <https://packages.wazuh.com/vm/wazuh3.8.0_6.5.4-disk1.vmdk>`_ disk.
