...
1. This virtual appliance, available `here <https://packages.wazuh.com/vm/wazuh3.7.2_6.5.2.ova>`_, contains the following components:
    ...
    - Elasticsearch 6.5.2
    - Logstash 6.5.2
    - Kibana 6.5.2 port "**5601**""
    - Wazuh app 3.7.2-6.5.2
...
.. note:: You can also download the virtual machine using the OVF format. You need to download the `OVF <https://packages.wazuh.com/vm/wazuh3.7.2_6.5.2.ovf>`_ file and the `vmdk <https://packages.wazuh.com/vm/wazuh3.7.2_6.5.2-disk001.vmdk>`_ disk.
