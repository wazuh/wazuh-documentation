...
.. note::
        ...
        You can also download the virtual machine using the OVF format. You need to download the `OVF <https://packages.wazuh.com/vm/wazuh|WAZUH_LATEST|_|ELASTICSEARCH_LATEST_OVA|.ovf>`_ file and the `vmdk <https://packages.wazuh.com/vm/wazuh|WAZUH_LATEST|_|ELASTICSEARCH_LATEST_OVA|-disk001.vmdk>`_ disk.
