...
1. This virtual appliance, available at https://packages.wazuh.com/vm/wazuh2.0.1_5.5.0.ova, contains the following components:
    ...
    - Elasticsearch 5.5.0
    - Logstash 5.5.0
    - Kibana 5.5.0 port "**5601**""
    - WazuhAPP 2.0.1_5.5.0
