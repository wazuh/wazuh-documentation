...
- Disk space requirements
  ...
  The amount of data depends on the generated alerts per second (APS). This table details the estimated disk space needed per agent to store 90 days of alerts on an Elasticsearch server, depending on the type of monitored endpoints.
