...
.. _wazuh_agent_packages_fedora22_or_greater:

Fedora 22 or greater
====================

The RPM package is suitable for installation on Fedora 22 or greater. For other operating systems or Linux distributions, please check the list: :doc:`Install Wazuh agent on Linux <wazuh_agent_packages_linux>`.
