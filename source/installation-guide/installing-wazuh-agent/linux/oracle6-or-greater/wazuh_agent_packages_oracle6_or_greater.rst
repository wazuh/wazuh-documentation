...
.. _wazuh_agent_packages_oracle6_or_greater:

Oracle Linux 6 or greater
=========================

The RPM package is suitable for Oracle Linux 6 or greater. For other operating systems or Linux distributions, please check the list: :doc:`Install Wazuh agent on Linux <wazuh_agent_packages_linux>`.
