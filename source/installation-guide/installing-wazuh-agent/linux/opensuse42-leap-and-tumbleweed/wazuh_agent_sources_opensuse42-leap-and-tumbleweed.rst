...
OpenSUSE 42, Leap and Tumbleweed
================================

This guide describes how to install the Wazuh agent from source code for OpenSUSE 42, Leap and Tumbleweed. For other operating systems or Linux distributions, please check the list: :doc:`Install Wazuh agent on Linux <wazuh_agent_sources_linux>`.
