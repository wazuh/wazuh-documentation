...
.. _wazuh_agent_packages_opensuse42_or_greater:

OpenSUSE 42, Leap and Tumbleweed
================================

The RPM package is suitable for installation on openSUSE 42, Leap and Tumbleweed. For other operating systems or Linux distributions, please check the list: :doc:`Install Wazuh agent on Linux <wazuh_agent_packages_linux>`.
