...
.. _wazuh_agent_packages_debian7_or_greater:

Debian 7 or greater
===================

The DEB package is suitable for Debian 7 or greater. For other operating systems or Linux distributions, please check the list: :doc:`Install Wazuh agent on Linux <wazuh_agent_packages_linux>`.
