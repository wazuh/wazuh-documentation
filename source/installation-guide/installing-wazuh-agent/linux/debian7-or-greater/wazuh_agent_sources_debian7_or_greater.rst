...
This guide describes how to install the Wazuh agent from source code for Debian 7 or greater. For other operating systems or Linux distributions, please check the list: :doc:`Install Wazuh agent on Linux <wazuh_agent_sources_linux>`.
