...
1. On your terminal, install the Wazuh agent. You can choose installation or deployment:
  ...
  a) Installation:
    ...
    .. code-block:: console
      ...
      # apt-get install wazuh-agent=|WAZUH_LATEST|-|WAZUH_REVISION_APT_AGENT_X86|
  ...
  b) Deployment:
    ...
    .. code-block:: console
      ...
      # WAZUH_MANAGER="10.0.0.2" apt-get install wazuh-agent=|WAZUH_LATEST|-|WAZUH_REVISION_APT_AGENT_X86|
