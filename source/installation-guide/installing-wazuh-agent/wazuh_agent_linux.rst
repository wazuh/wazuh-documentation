...
+===============================+=====================+===========================================================================================+
| Amazon Linux                  | 2                   | :doc:`Installation guide Amazon Linux/CentOS/Red Hat/Oracle Linux <wazuh_agent_linux_rpm>`|
+                               +---------------------+                                                                                           +
|                               | 1                   |                                                                                           |
+-------------------------------+---------------------+                                                                                           +
...
|                               | 6                   |                                                                                           |
+                               +---------------------+-------------------------------------------------------------------------------------------+
|                               | 5                   | :doc:`Installation guide CentOS/Red Hat/Oracle Linux 5 <wazuh_agent_linux_rpm_5>`         |
+-------------------------------+---------------------+-------------------------------------------------------------------------------------------+
| Debian                        | 9                   | :doc:`Installation guide Debian/Ubuntu<wazuh_agent_linux_deb>`                            |
+                               +---------------------+                                                                                           +
|                               | 8                   |                                                                                           |
+                               +---------------------+                                                                                           +
|                               | 7                   |                                                                                           |
