...
+-------------------------------+---------------+----------------------------------------------------------------------------------+
| CentOS/Red Hat/Oracle Linux   | 7             | :doc:`Installation guide on CentOS/RHEL/Oracle Linux 7 <wazuh_agent_linux_rpm>`  |
+                               +---------------+----------------------------------------------------------------------------------+
|                               | 6             | :doc:`Installation guide on CentOS/RHEL/Oracle Linux 6 <wazuh_agent_linux_rpm>`  |
+                               +---------------+----------------------------------------------------------------------------------+
