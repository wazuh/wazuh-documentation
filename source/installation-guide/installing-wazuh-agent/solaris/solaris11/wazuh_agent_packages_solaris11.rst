...
The Wazuh agent for Solaris can be downloaded from our :doc:`packages list <packages>`. The current version has been tested on Solaris 11 version 5.11. Install the agent as follows:
