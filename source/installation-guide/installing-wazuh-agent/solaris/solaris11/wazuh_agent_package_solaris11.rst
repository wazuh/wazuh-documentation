...
The Wazuh agent for Solaris can be downloaded from our :ref:`packages list<packages>`. The current version has been tested on Solaris 11 version 5.11. Install the agent as follows:
  ...
  a) For Solaris 11 i386:
    ...
    .. code-block:: console
      ...
      # pkg install -g wazuh-agent_v3.11.1-sol11-i386.p5p wazuh-agent

  b) For Solaris 11 SPARC:

    .. code-block:: console

      # pkg install -g wazuh-agent_v3.11.1-sol11-sparc.p5p wazuh-agent
...
a) For Solaris 11 i386:
    .. code-block:: console
        ...
        # pkg set-publisher -g wazuh-agent_v3.11.1-sol11-i386.p5p wazuh
b) For Solaris 11 sparc:
    .. code-block:: console

        # pkg set-publisher -g wazuh-agent_v3.11.1-sol11-sparc.p5p wazuh
