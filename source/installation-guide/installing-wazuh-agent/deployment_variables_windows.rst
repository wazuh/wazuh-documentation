...
Registration with password::
    ...
    wazuh-agent-3.9.4-1.msi /q ADDRESS="10.0.0.2" AUTHD_SERVER="10.0.0.2" PASSWORD="TopSecret" AGENT_NAME="W2012"

Registration with password and assigning a group::

    wazuh-agent-3.9.4-1.msi /q ADDRESS="10.0.0.2" AUTHD_SERVER="10.0.0.2" PASSWORD="TopSecret" GROUP="my-group"

Registration with relative path to CA. It will be searched at your `APPLICATIONFOLDER` folder::

    wazuh-agent-3.9.4-1.msi /q ADDRESS="10.0.0.2" AUTHD_SERVER="10.0.0.2" AGENT_NAME="W2019" CERTIFICATE="rootCA.pem"

Absolute paths to CA, certificate or key that contain spaces can be written as shown below::

    wazuh-agent-3.9.4-1.msi /q ADDRESS="10.0.0.2" AUTHD_SERVER="10.0.0.2" KEY="C:\Progra~2\sslagent.key" PEM="C:\Progra~2\sslagent.cert"
...
Registration with protocol::
    ...
    wazuh-agent-3.9.4-1.msi /q ADDRESS="10.0.0.2" AUTHD_SERVER="10.0.0.2" AGENT_NAME="W2016" PROTOCOL="TCP"
