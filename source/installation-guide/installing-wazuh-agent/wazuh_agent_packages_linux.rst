...
.. _wazuh_agent_packages_linux:

Install Wazuh agent on Linux
============================

The Wazuh agent can be installed in the following operative systems:


+-------------------------------+---------------------------------------------------------------+
| Operative system              | Version                                                       |
+===============================+===============================================================+
| Amazon Linux                  | :doc:`1 or greater <wazuh_agent_packages_linux_rpm>`          |
+-------------------------------+---------------------------------------------------------------+
| CentOS                        | :doc:`6 or greater <wazuh_agent_packages_linux_rpm>`          |
+                               +---------------------------------------------------------------+
...
.. toctree::
    ...
    wazuh_agent_packages_linux_rpm
    wazuh_agent_packages_linux_deb
    wazuh_agent_packages_linux_rpm_5
    wazuh_agent_packages_linux_fedora
    wazuh_agent_packages_linux_rpm_suse_12
    wazuh_agent_packages_linux_rpm_suse_11
