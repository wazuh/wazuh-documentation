...
You can download the `AIX installer <https://packages.wazuh.com/3.x/aix/wazuh-agent-3.11.4-1.aix.ppc.rpm>`_ from our :ref:`packages list <packages>`. You can choose installation or a deployment:
  ...
  b) Deployment:
    ...
    .. code-block:: console
      ...
      # WAZUH_MANAGER="10.0.0.2" rpm -ivh wazuh-agent-3.11.4-1.aix.ppc.rpm
