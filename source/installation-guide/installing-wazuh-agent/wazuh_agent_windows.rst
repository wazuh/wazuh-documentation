...
To install the Windows agent from the command line, run the installer using the following command (the ``/q`` argument is used for unattended installations)::
    ...
    wazuh-agent-|WAZUH_LATEST|-|WAZUH_LATEST_WINDOWS|.msi /q
...
Usage example::
    ...
    wazuh-agent-|WAZUH_LATEST|-|WAZUH_LATEST_WINDOWS|.msi /q ADDRESS="192.168.1.1" AUTHD_SERVER="192.168.1.1" PASSWORD="TopSecret" AGENT_NAME="W2012"
