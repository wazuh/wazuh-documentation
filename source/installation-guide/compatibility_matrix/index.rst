...
+-------------------------------------------+---------------------------+
|                                           |                           |
+  **API and Wazuh Kibana plugin version**  + **Elastic Stack version** +
|                                           |                           |
+-------------------------------------------+---------------------------+
...
You can find more information on the `Wazuh Kibana plugin repository <https://github.com/wazuh/wazuh-kibana-app#installation>`_, where you can check a more detailed compatibility matrix between the Wazuh app and Elastic Stack versions.
