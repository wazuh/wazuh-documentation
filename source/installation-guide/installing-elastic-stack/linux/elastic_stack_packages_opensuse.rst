...
.. meta:: :description: Learn how to install Elastic Stack for using Wazuh on OpenSUSE
...
For OpenSUSE Leap 42, installing the Elastic stack components entails the installation of the relevant packages after adding the repositories.
