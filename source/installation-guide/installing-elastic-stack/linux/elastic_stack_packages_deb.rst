...
.. include:: ../../../_templates/installations/deb/add_repository.rst
...
#. Install the Elasticsearch package:
    ...
    .. include:: ../../../_templates/installations/deb/install_elasticsearch.rst

#. Configure Elasticsearch:

    .. include:: ../../../_templates/installations/common/elastic-single-node/configure_elasticsearch.rst
...
#. Enable and start the Elasticsearch service:
    ...
    .. include:: ../../../_templates/installation-guide/aio/common/enable_elasticsearch.rst

#. Generate credentials for all the Elastic Stack pre-built roles and users:

    .. include:: ../../../_templates/installation-guide/aio/common/generate_password.rst
...
#. Install the Kibana package:
    ...
    .. include:: ../../../_templates/installation-guide/aio/deb/install_kibana.rst

#. Configure certificates. Copy the certificates from the Elasticsearch configuration folder into the kibana:

    .. include:: ../../../_templates/installation-guide/aio/common/copy_kibana_certificates.rst

#. Configure Kibana:

    .. include:: ../../../_templates/installation-guide/aio/common/configure_kibana.rst

#. Install the Wazuh Kibana plugin. You can install it by using an URL (a) or a previously downloaded package (b):

    .. include:: ../../../_templates/installation-guide/aio/common/install_kibana_plugin.rst

#. Enable and start the Kibana service:

    .. include:: ../../../_templates/installation-guide/aio/common/enable_kibana.rst

.. include:: ../../../_templates/installation-guide/aio/common/kibana_final_note.rst

Disabling repositories
----------------------

.. include:: ../../../_templates/installation-guide/aio/common/disabling_repositories_explanation.rst

In order to anticipate and avoid this situation, we recommend disabling the Elasticsearch repository in the following way:

.. include:: ../../../_templates/installation-guide/aio/deb/disabling_repositories.rst

Next steps
----------

.. include:: ../../../_templates/installation-guide/aio/common/next_steps.rst
...
.. include:: ../../../_templates/installation-guide/aio/deb/uninstall_elasticsearch.rst

To uninstall Kibana:

.. include:: ../../../_templates/installation-guide/aio/deb/uninstall_kibana.rst
