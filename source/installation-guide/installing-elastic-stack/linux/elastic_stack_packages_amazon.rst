...
.. meta:: Learn how to install Elastic Stack for using Wazuh on Amazon Linux
...
For Amazon Linux 1 or greater, installing the Elastic stack components entails the installation of the relevant packages after adding the repositories.
