...
.. meta:: Learn how to install Elastic Stack for using Wazuh on Oracle Linux
...
For Oracle Linux 6 or greater, installing the Elastic stack components entails the installation of the relevant packages after adding the repositories.
