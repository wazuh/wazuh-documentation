...
3. Install Logstash.
  ...
  * For Debian/Ubuntu:
    ...
    .. code-block:: console
      ...
      # apt-get install logstash=1:7.5.2-1
      # systemctl daemon-reload
      # systemctl enable logstash
...
4. Download the Wazuh configuration file for Logstash.
  ...
  .. code-block:: console
    ...
    # curl -so /etc/logstash/conf.d/01-wazuh.conf https://raw.githubusercontent.com/wazuh/wazuh/v3.11.2/extensions/logstash/7.x/01-wazuh-remote.conf
