...
`Solaris systems <https://documentation.wazuh.com/current/installation-guide/wazuh-agent/wazuh-agent-package-solaris.html>`_      You can monitor your Solaris systems with Wazuh. All you need to do to start the installation process is select your architecture between i386 or Sparc. 
