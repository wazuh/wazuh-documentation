...
- :ref:`All-in-one <all_in_one_index>`: All the Wazuh components are installed on the same host. You can choose between unattended installation, which is an automated way of installing the solution with a single script, or step-by-step installation, a manual way of carrying out the process. Moreover, you can download our ready-to-use :ref:`OVA <virtual_machine>` to start using Wazuh with this deployment option.
