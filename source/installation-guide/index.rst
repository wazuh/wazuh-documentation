...
The purpose of this guide is that you can easily install each of the central components and the agent as an all-in-one deployment or on different servers as a distributed deployment depending on your environment needs.
