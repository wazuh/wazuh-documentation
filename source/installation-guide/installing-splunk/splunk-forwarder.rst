...
1. Download Splunk Forwarder v|ELASTICSEARCH_LATEST| package from `the official website <https://www.splunk.com/en_us/download/universal-forwarder.html>`_.
...
3. Ensure Splunk Forwarder v|ELASTICSEARCH_LATEST| is installed in ``/opt/splunkforwarder``.
...
1. Download and insert the ``props.conf`` template:
    ...
    .. code-block:: console
      ...
      # curl -so /opt/splunkforwarder/etc/system/local/props.conf https://raw.githubusercontent.com/wazuh/wazuh/v|WAZUH_LATEST|/extensions/splunk/props.conf
...
1. Download and insert the ``inputs.conf`` template:
    ...
    .. code-block:: console
      ...
      # curl -so /opt/splunkforwarder/etc/system/local/inputs.conf https://raw.githubusercontent.com/wazuh/wazuh/v|WAZUH_LATEST|/extensions/splunk/inputs.conf
