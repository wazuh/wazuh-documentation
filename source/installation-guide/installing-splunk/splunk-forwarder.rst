...
1. Download and insert the ``props.conf`` template:
    ...
    .. code-block:: console
      ...
      # curl -so /opt/splunkforwarder/etc/system/local/props.conf https://raw.githubusercontent.com/wazuh/wazuh/v3.11.4/extensions/splunk/props.conf
...
1. Download and insert the ``inputs.conf`` template:
    ...
    .. code-block:: console
      ...
      # curl -so /opt/splunkforwarder/etc/system/local/inputs.conf https://raw.githubusercontent.com/wazuh/wazuh/v3.11.4/extensions/splunk/inputs.conf
