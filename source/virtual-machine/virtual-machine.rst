...
.. note::
  ...
  This VM only runs on 64-bit systems and does not provide high availability and scalability of the product. Multi-node clusters are generally more suitable for environments where higher performance is required.
