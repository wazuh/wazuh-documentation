...
.. meta:: :description: Wazuh manager sources installation on CentOS
...
This guide describes how to install the manager and API for CentOS 6 or greater from source code. In addition, for multitier server, you will find some guidance on how to install Filebeat.
