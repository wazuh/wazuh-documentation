...
3. Ensure Splunk v8.0.1 is installed in ``/opt/splunk`` and start the service:
...
- To learn more about the Splunk distributed search, check out `this article <http://docs.splunk.com/Documentation/Splunk/8.0.1/DistSearch/Whatisdistributedsearch>`_ from the official documentation.
