...
You can download the `AIX installer <https://packages.wazuh.com/3.x/aix/wazuh-agent-|WAZUH_LATEST|-|WAZUH_REVISION|.aix.ppc.rpm>`_ from our :ref:`packages list <packages>`. You can choose installation or a deployment:

  a) Installation:

    .. code-block:: console

      # rpm -ivh wazuh-agent-|WAZUH_LATEST|-|WAZUH_REVISION|.aix.ppc.rpm
  ...
  b) Deployment:
    ...
    .. code-block:: console
      ...
      # WAZUH_MANAGER="10.0.0.2" rpm -ivh wazuh-agent-|WAZUH_LATEST|-|WAZUH_REVISION|.aix.ppc.rpm
