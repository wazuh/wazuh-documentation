...
Upgrading the Wazuh agents remotely is possible by using the ``agent_upgrade`` tool and the Wazuh API. More information about the process can be found in the :doc:`Remote agent upgrade </user-manual/agent/agents/remote-upgrading/upgrading-agent>` section.
