...
Upgrading the Wazuh agents remotely is possible by using the Wazuh API. More information about the process can be found in the :doc:`Remote agent upgrade </user-manual/agent/agent-management/remote-upgrading/upgrading-agent>` section.
