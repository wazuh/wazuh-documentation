...
10. Load the Wazuh template for Elasticsearch:
  ...
  .. code-block:: console
    ...
    # curl https://raw.githubusercontent.com/wazuh/wazuh/v3.11.2/extensions/elasticsearch/6.x/wazuh-template.json | curl -X PUT "http://localhost:9200/_template/wazuh" -H 'Content-Type: application/json' -d @-
...
2. Download and set the Wazuh configuration for Logstash:
  ...
  a) Local configuration:
    ...
    .. code-block:: console
      ...
      # curl -so /etc/logstash/conf.d/01-wazuh.conf https://raw.githubusercontent.com/wazuh/wazuh/v3.11.2/extensions/logstash/6.x/01-wazuh-local.conf
  ...
  b) Remote configuration:
    ...
    .. code-block:: console
      ...
      # cp /etc/logstash/conf.d/01-wazuh.conf /backup_directory/01-wazuh.conf.bak
      # curl -so /etc/logstash/conf.d/01-wazuh.conf https://raw.githubusercontent.com/wazuh/wazuh/v3.11.2/extensions/logstash/6.x/01-wazuh-remote.conf
...
2. Update the configuration file.
  ...
  .. code-block:: console
    ...
    # curl -so /etc/filebeat/filebeat.yml https://raw.githubusercontent.com/wazuh/wazuh/v3.11.2/extensions/filebeat/6.x/filebeat.yml
...
3. Upgrade the Wazuh app:
  ...
  .. code-block:: console
    ...
    # sudo -u kibana NODE_OPTIONS="--max-old-space-size=3072" /usr/share/kibana/bin/kibana-plugin install https://packages.wazuh.com/wazuhapp/wazuhapp-3.11.2_6.8.6.zip
