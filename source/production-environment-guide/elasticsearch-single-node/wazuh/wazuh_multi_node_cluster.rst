...
.. _wazuh_multi_node_cluster_elasticsearch_single_node_cluster:
...
.. _wazuh_server_multi_node_elastic_single_node_filebeat:
...
#. Download the Filebeat config file from the Wazuh repository. This is pre-configured to forward Wazuh alerts to Elasticsearch:
    ...
    .. code-block:: console
      ...
      # curl -so /etc/filebeat/filebeat.yml https://raw.githubusercontent.com/wazuh/wazuh/elastic-secured-3.10/extensions/filebeat/7.x/filebeat_cluster.yml
