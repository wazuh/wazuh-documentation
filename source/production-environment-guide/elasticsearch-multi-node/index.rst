...
+=====================+==============================================================================================+
| Single-node cluster | :ref:`Wazuh single-node cluster<wazuh_single_node_cluster_elasticsearch_multi_node_cluster>` |
+---------------------+----------------------------------------------------------------------------------------------+
| Multi-node cluster  | :ref:`Wazuh multi-node cluster<wazuh_multi_node_cluster_elasticsearch_multi_node_cluster>`   |
+---------------------+----------------------------------------------------------------------------------------------+
