...
.. meta:: :description: Learn how to install Elastic Stack for using Wazuh on Red Hat Enterprise Linux

.. _wcluster_ecluster_rhel:


Red Hat Enterprise Linux
========================

To install the Elastic Stack components on Red Hat Enterprise Linux 6 or higher versions, you have to install the relevant packages after you've added the repositories.
