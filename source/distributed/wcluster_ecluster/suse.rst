...
.. meta:: :description: Learn how to install Elastic Stack for using Wazuh on SUSE

.. _wcluster_ecluster_suse:


SUSE
====

To install the Elastic Stack components on SUSE 12, you have to install the relevant packages after you've added the repositories.
