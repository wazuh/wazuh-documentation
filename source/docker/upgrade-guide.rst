...
.. meta::
  :description: With Docker, you can automate the deployment of applications inside containers. Learn about the upgrade of a cluster running version previous to 4.x. here. 
