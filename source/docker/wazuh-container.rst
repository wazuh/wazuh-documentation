...
1. Get the ``docker-compose.yml`` file to your system:
  ...
  a) Only the file::
      ...
      $ curl -so docker-compose.yml https://raw.githubusercontent.com/wazuh/wazuh-docker/v|WAZUH_LATEST_DOCKER|_7.6.1/docker-compose.yml

  b) Get the Wazuh repository::

      $ git clone https://github.com/wazuh/wazuh-docker.git -b v|WAZUH_LATEST_DOCKER|_7.6.1 --single-branch
