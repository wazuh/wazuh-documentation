...
.. meta::
  :description: Check out this section of the Wazuh documentation to learn more about the Docker installation and how to install the Docker engine and the Docker compose. 
