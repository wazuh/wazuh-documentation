...
.. meta::
  :description: Learn how to configure an Amazon S3, an object storage service that delivers industry-leading scalability, data availability, security, and performance.
