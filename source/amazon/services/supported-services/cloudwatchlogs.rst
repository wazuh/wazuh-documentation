...
`AWS CloudWatch Logs <https://aws.amazon.com/cloudwatch/>`_ is a service that allow the users to centralize the logs from all their systems, applications and AWS services in a single place. In order to understand how Cloudwatch Logs works it's important to learn about the following concepts:
