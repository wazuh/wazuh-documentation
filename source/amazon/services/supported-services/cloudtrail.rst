...
When an instance in EC2 is started, the following alert will be shown on Wazuh dashboard, it shows information such as the instance id and the user who started it:
...
When a new security group is created, the following alert is shown on Wazuh dashboard. It shows information such as the user who created it and information about the security group:
...
If an unauthorized user attempts to create new users, the following alert will be shown in Wazuh dashboard. It will show you which user has tried to create an user account and the username it tried to create:
...
When an user tries to log in with an invalid password, the following alert will be shown in Wazuh dashboard. There will be shown data such as the user who tried to login or the browser it was using:
...
After a successful login, the following event will be shown in Wazuh dashboard. It shows the user who logged in, the browser it used and many other useful information:
