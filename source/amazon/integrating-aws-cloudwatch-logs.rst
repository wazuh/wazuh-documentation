...
Thanks to the Wazuh ``AWS-S3`` module we can pull and analyze events from CloudWatch Logs. As a result, we can be aware of errors, misconfigurations, attempted malicious activities, and many other security concerns for our AWS applications, services, and systems. Most importantly, once the logs are collected we can take advantage of all the useful capabilities that Wazuh offers, such as the ability to react to any kind of alert using our Active Response module.
...
If you have any questions about this, don’t hesitate to check out our `documentation <https://documentation.wazuh.com/>`_ to learn more about Wazuh. You can also join our `Slack #community channel <https://wazuh.com/community/join-us-on-slack/>`_ and our `mailing list <http://bit.ly/wazuh-mailing-list>`_ where our team and other users will help you with your questions.
