...
custom_replacements = {
    ...
    "|WAZUH_LATEST_ANSIBLE|" : "4.3.2",
    "|WAZUH_LATEST_MINOR_ANSIBLE|" : "4.3",
    "|WAZUH_LATEST_KUBERNETES|" : "4.3.2",
    "|WAZUH_LATEST_PUPPET|" : "4.3.2",
    "|WAZUH_LATEST_OVA|" : "4.3.2",
    "|WAZUH_LATEST_AMI|" : "4.3.2",
    "|WAZUH_LATEST_DOCKER|" : "4.3.2",
    "|WAZUH_LATEST_AIX|" : "4.3.2",
    "|WAZUH_LATEST_MINOR_AIX|" : "4.3",
    "|WAZUH_LATEST_FROM_SOURCES|" : "4.3.2",
    "|WAZUH_LATEST_MINOR_FROM_SOURCES|" : "4.3",
    "|WAZUH_LATEST_WIN_FROM_SOURCES|" : "4.3.2",
