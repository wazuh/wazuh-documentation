...
custom_replacements = {
    ...
    "|CHECKSUMS_URL|" : "https://packages-dev.wazuh.com/pre-release/checksums/wazuh/",
    "|RPM_AGENT|" : "https://packages-dev.wazuh.com/pre-release/yum/wazuh-agent",
    "|RPM_MANAGER|" : "https://packages-dev.wazuh.com/pre-release/yum/wazuh-manager",
    "|DEB_AGENT|" : "https://packages-dev.wazuh.com/pre-release/apt/pool/main/w/wazuh-agent/wazuh-agent",
    "|DEB_MANAGER|" : "https://packages-dev.wazuh.com/pre-release/apt/pool/main/w/wazuh-manager/wazuh-manager",
    "|DEB_API|" : "https://packages-dev.wazuh.com/pre-release/apt/pool/main/w/wazuh-api/wazuh-api",
