...
.. code-block:: console
  ...
  # curl -so /etc/elasticsearch/elasticsearch.yml https://raw.githubusercontent.com/wazuh/wazuh-documentation/develop/resources/open-distro/elasticsearch/7.x/elasticsearch.yml
