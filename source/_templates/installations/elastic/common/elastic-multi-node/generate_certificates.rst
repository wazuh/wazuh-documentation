...
#. Copy ``certs.tar`` to all the servers of the distributed deployment including, Wazuh indexer, Wazuh server, and Wazuh dashboard nodes. This can be done by using, for example, ``scp``. 
