...
#. Download the ``/etc/elasticsearch/elasticsearch.yml`` file.
    ...
    .. code-block:: console
      ...
      # curl -so /etc/elasticsearch/elasticsearch.yml https://raw.githubusercontent.com/wazuh/wazuh-documentation/3128-Certificate_tool/resources/open-distro/elasticsearch/7.x/elasticsearch_cluster_initial_node.yml
