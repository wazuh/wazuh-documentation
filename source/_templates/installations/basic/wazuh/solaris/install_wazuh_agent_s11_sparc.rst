...
The Wazuh agent for Solaris 11 Sparc can be downloaded from our :ref:`packages list<packages>` or directly from here: `Solaris 11 Sparc <https://packages-dev.wazuh.com/pre-release/solaris/sparc/11/wazuh-agent_v4.2.0-sol11-sparc.p5p>`_. The current version has been tested on Solaris 11 Sparc version 5.10. Install the agent as follows:
...
.. code-block:: console
  ...
  # pkg set-publisher -g wazuh-agent_v4.2.0-sol11-sparc.p5p wazuh
