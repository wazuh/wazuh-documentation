...
.. code-block:: console
  ...
  # curl -so /etc/elasticsearch/elasticsearch.yml https://documentation.wazuh.com/4.1/resources/elastic-stack/elasticsearch/7.x/elasticsearch_cluster_initial_node.yml
