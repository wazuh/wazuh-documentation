...
#. Install the Wazuh agent.
   ...
   .. code-block:: console
     ...
     # pkg install -g wazuh-agent_v4.3.10-sol11-sparc.p5p wazuh-agent
...
.. code-block:: console
  ...
  # pkg set-publisher -g wazuh-agent_v4.3.10-sol11-sparc.p5p wazuh && pkg install --accept wazuh-agent && pkg unset-publisher wazuh
