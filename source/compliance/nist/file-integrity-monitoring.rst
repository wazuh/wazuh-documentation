...
#. Select the **Integrity monitoring** module from the Wazuh dashboard. Find the alert triggered by rule ID ``550``. The alert details show that the content of ``/etc/ssh/sshd_config`` has changed. They include the differences in the file checksum, the modification made, the modification time, and other information.

   .. thumbnail:: /images/compliance/nist/integrity-monitoring-tab.png    
      :title: Integrity monitoring module
      :alt: Integrity monitoring module
      :align: center
      :width: 80%
