...
#. Enable the Vulnerability Detection module. This is found under the ``<vulnerability-detector>`` block of the Wazuh server ``/var/ossec/etc/ossec.conf`` configuration file:
