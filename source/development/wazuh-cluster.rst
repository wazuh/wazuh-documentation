...
.. code-block:: console
    ...
    File "/var/ossec/framework/python/lib/python3.7/site-packages/wazuh-3.11.1-py3.7.egg/wazuh/cluster/cluster.py", line 213, in walk_dir
        entry_metadata['md5'] = md5(common.ossec_path + full_path)
    File "/var/ossec/framework/python/lib/python3.7/site-packages/wazuh-3.11.1-py3.7.egg/wazuh/utils.py", line 380, in md5
