...
.. code-block:: none
 ...
 Usage: ./generate_wazuh_packages.sh [OPTIONS]
    ...
    -e, --environment                   Install all the packages necessaries to build the solaris package.
    ...
    -c, --checksum                      Compute the SHA512 checksum of the solaris package.
...
We also provide an automated way of building packages for i386 Solaris systems using vagrant, to use this download our wazuh-packages repository from GitHub, change to the |WAZUH_PACKAGES_BRANCH| branch and go to the ``solaris/package_generation`` directory.
