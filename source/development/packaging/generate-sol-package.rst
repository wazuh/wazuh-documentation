...
Download our wazuh-packages repository from GitHub and go to the ``solaris`` directory of the 4.0 branch.
...
We also provide an automated way of building packages for i386 Solaris systems using vagrant, to use this download our wazuh-packages repository from GitHub, change to 4.0 branch and go to the ``solaris/package_generation`` directory.
