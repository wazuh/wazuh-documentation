...
Download our wazuh-packages repository from GitHub and go to the macos directory of the 4.0 branch.

.. code-block:: console

  $ git clone https://github.com/wazuh/wazuh-packages && cd wazuh-packages/macos && git checkout 4.0
