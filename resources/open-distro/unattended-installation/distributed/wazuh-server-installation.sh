...
installFilebeat() {
    ...
    then
        ...
        eval "curl -so /etc/filebeat/filebeat.yml https://documentation.wazuh.com/4.1/resources/open-distro/unattended-installation/distributed/templates/filebeat.yml --max-time 300 ${debug}"
