...
installElasticsearch() {
    ...
    if [  "$?" != 0  ]; then
        ...
        eval "curl -so /etc/elasticsearch/elasticsearch.yml https://documentation.wazuh.com/4.1/resources/open-distro/unattended-installation/distributed/templates/elasticsearch_unattended.yml --max-time 300 ${debug}"
...
createCertificates() {
    ...
    eval "curl -so ~/searchguard/search-guard.yml https://documentation.wazuh.com/4.1/resources/open-distro/unattended-installation/distributed/templates/search-guard-unattended.yml --max-time 300 ${debug}"
...
installKibana() {
    ...
    if [  "$?" != 0  ]; then
        ...
        eval "curl -so /etc/kibana/kibana.yml https://documentation.wazuh.com/4.1/resources/open-distro/unattended-installation/distributed/templates/kibana_unattended.yml --max-time 300 ${debug}"
