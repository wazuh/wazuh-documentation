...
- **Post-release**: Removed a stale, unpublished `pm_event` table from the *wazuh-db* daemon reference and dropped two `wodle-osquery` cross-references from the *Deploying with Ansible* reference that pointed at the wrong page. ([#10138](https://github.com/wazuh/wazuh-documentation/pull/10138))
