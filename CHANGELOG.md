...
- Added the *Migration guide* documentation. ([#9772](https://github.com/wazuh/wazuh-documentation/pull/9772)) ([#9792](https://github.com/wazuh/wazuh-documentation/pull/9792)) ([#9817](https://github.com/wazuh/wazuh-documentation/pull/9817)) ([#9873](https://github.com/wazuh/wazuh-documentation/pull/9873)) ([#10028](https://github.com/wazuh/wazuh-documentation/pull/10028)) ([#10067](https://github.com/wazuh/wazuh-documentation/pull/10067))
...
- Updated the *Installation guide*. ([#9545](https://github.com/wazuh/wazuh-documentation/pull/9545)) ([#9682](https://github.com/wazuh/wazuh-documentation/pull/9682)) ([#9692](https://github.com/wazuh/wazuh-documentation/pull/9692)) ([#9736](https://github.com/wazuh/wazuh-documentation/pull/9736)) ([#9771](https://github.com/wazuh/wazuh-documentation/pull/9771)) ([#9962](https://github.com/wazuh/wazuh-documentation/pull/9962)) ([#9968](https://github.com/wazuh/wazuh-documentation/pull/9968)) ([#9969](https://github.com/wazuh/wazuh-documentation/pull/9969)) ([#9994](https://github.com/wazuh/wazuh-documentation/pull/9994)) ([#10002](https://github.com/wazuh/wazuh-documentation/pull/10002)) ([#10019](https://github.com/wazuh/wazuh-documentation/pull/10019)) ([#10187](https://github.com/wazuh/wazuh-documentation/pull/10187))
...
- Updated the *Wazuh agent* documentation in *User manual*. ([#9665](https://github.com/wazuh/wazuh-documentation/pull/9665)) ([#9669](https://github.com/wazuh/wazuh-documentation/pull/9669)) ([#9701](https://github.com/wazuh/wazuh-documentation/pull/9701)) ([#9702](https://github.com/wazuh/wazuh-documentation/pull/9702)) ([#9812](https://github.com/wazuh/wazuh-documentation/pull/9812)) ([#9993](https://github.com/wazuh/wazuh-documentation/pull/9993)) ([#10035](https://github.com/wazuh/wazuh-documentation/pull/10035)) ([#10065](https://github.com/wazuh/wazuh-documentation/pull/10065))
- Updated the *Wazuh dashboard* documentation in *User manual*. ([#9688](https://github.com/wazuh/wazuh-documentation/pull/9688)) ([#10033](https://github.com/wazuh/wazuh-documentation/pull/10033)) ([#10036](https://github.com/wazuh/wazuh-documentation/pull/10036))
...
- Updated the *Wazuh server* documentation to the new *Wazuh manager* documentation in the *User manual*. ([#9728](https://github.com/wazuh/wazuh-documentation/pull/9728)) ([#9737](https://github.com/wazuh/wazuh-documentation/pull/9737)) ([#10064](https://github.com/wazuh/wazuh-documentation/pull/10064))
- Updated the *User administration* documentation. ([#9745](https://github.com/wazuh/wazuh-documentation/pull/9745)) ([#9758](https://github.com/wazuh/wazuh-documentation/pull/9758)) ([#9765](https://github.com/wazuh/wazuh-documentation/pull/9765)) ([#9766](https://github.com/wazuh/wazuh-documentation/pull/9766)) ([#9775](https://github.com/wazuh/wazuh-documentation/pull/9775)) ([#10040](https://github.com/wazuh/wazuh-documentation/pull/10040))
...
- Updated the *Container security* documentation. ([#9816](https://github.com/wazuh/wazuh-documentation/pull/9816)) ([#9819](https://github.com/wazuh/wazuh-documentation/pull/9819)) ([#9823](https://github.com/wazuh/wazuh-documentation/pull/9823)) ([#10206](https://github.com/wazuh/wazuh-documentation/pull/10206))
...
- Updated the *Security configuration assessment* capability documentation. ([#9834](https://github.com/wazuh/wazuh-documentation/pull/9834)) ([#9849](https://github.com/wazuh/wazuh-documentation/pull/9849)) ([#10178](https://github.com/wazuh/wazuh-documentation/pull/10178))
...
- Updated the *File integrity monitoring* capability documentation to Wazuh 5.0. ([#9961](https://github.com/wazuh/wazuh-documentation/pull/9961)) ([#10165](https://github.com/wazuh/wazuh-documentation/pull/10165))
...
- Updated the *Using Wazuh for GDPR compliance* documentation in *Regulatory compliance* to Wazuh 5.0. ([#9944](https://github.com/wazuh/wazuh-documentation/pull/9944)) ([#10191](https://github.com/wazuh/wazuh-documentation/pull/10191))
- Updated the *Monitoring Linux system calls* capability documentation to Wazuh 5.0. ([#10010](https://github.com/wazuh/wazuh-documentation/pull/10010))
- Updated the *Wazuh indexer API reference*, removing the non-tracked version number from its page header, grouping its sections by plugin, and fixing a duplicate tag name that could merge two unrelated sections. ([#10015](https://github.com/wazuh/wazuh-documentation/pull/10015)) ([#10016](https://github.com/wazuh/wazuh-documentation/pull/10016)) ([#10017](https://github.com/wazuh/wazuh-documentation/pull/10017)) ([#10025](https://github.com/wazuh/wazuh-documentation/pull/10025)) ([#10041](https://github.com/wazuh/wazuh-documentation/pull/10041)) ([#10042](https://github.com/wazuh/wazuh-documentation/pull/10042)) ([#10043](https://github.com/wazuh/wazuh-documentation/pull/10043)) ([#10044](https://github.com/wazuh/wazuh-documentation/pull/10044)) ([#10048](https://github.com/wazuh/wazuh-documentation/pull/10048))
- Updated the *Using Wazuh for TSC compliance* documentation in *Regulatory compliance* to Wazuh 5.0. ([#10027](https://github.com/wazuh/wazuh-documentation/pull/10027)) ([#10045](https://github.com/wazuh/wazuh-documentation/pull/10045)) ([#10191](https://github.com/wazuh/wazuh-documentation/pull/10191))
...
- Updated the *Reference* documentation to Wazuh 5.0, splitting the local configuration reference into separate `wazuh-manager.conf` and `ossec.conf` sections, renaming manager daemons and tools with the `wazuh-manager-` prefix, updating the internal configuration, daemons, and tools references, and removing documentation for configuration sections and CLI tools no longer supported in Wazuh 5.0. ([#10047](https://github.com/wazuh/wazuh-documentation/pull/10047)) ([#10070](https://github.com/wazuh/wazuh-documentation/pull/10070)) ([#10071](https://github.com/wazuh/wazuh-documentation/pull/10071)) ([#10072](https://github.com/wazuh/wazuh-documentation/pull/10072)) ([#10177](https://github.com/wazuh/wazuh-documentation/pull/10177))
...
- Updated the *Using Wazuh for PCI DSS compliance* documentation in *Regulatory compliance* to Wazuh 5.0. ([#10066](https://github.com/wazuh/wazuh-documentation/pull/10066)) ([#10191](https://github.com/wazuh/wazuh-documentation/pull/10191))
...
- Updated the *Using Wazuh for HIPAA compliance* documentation in *Regulatory compliance* to Wazuh 5.0. ([#10083](https://github.com/wazuh/wazuh-documentation/pull/10083)) ([#10191](https://github.com/wazuh/wazuh-documentation/pull/10191))
...
- **Post-release**: Fixed reference-page formatting and completeness issues and worked-example value mismatches across the *Reference*, *Indexer API*, *Ruleset*, and *User manual* documentation. ([#10129](https://github.com/wazuh/wazuh-documentation/pull/10129)) ([#10136](https://github.com/wazuh/wazuh-documentation/pull/10136))
...
- **Post-release**: Fixed Change the password of Wazuh users steps in the *Deployment on Kubernetes* guide. ([#9296](https://github.com/wazuh/wazuh-documentation/pull/9296))
