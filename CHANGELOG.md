...
- **Post-release**: Added the *System requirements* section to the *Wazuh server cluster* documentation. ([#9673](https://github.com/wazuh/wazuh-documentation/pull/9673))
