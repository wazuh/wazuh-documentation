...
- Updated the *Wazuh manager* documentation, covering the new HTTPS agent API on port `1517` for enrollment and event ingestion, the `wazuh_config` root configuration element rename, and related Wazuh indexer connector, Wazuh manager services, and Logging configuration changes. ([#10064](https://github.com/wazuh/wazuh-documentation/pull/10064))
