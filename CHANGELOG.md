...
- Added a note in the installation guide about firewall configuration to prevent communication issues between Wazuh components. ([#8606](https://github.com/wazuh/wazuh-documentation/pull/8606))
