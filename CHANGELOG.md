...
- **Post-release**: Updated user manual documentation for dashboard queries, multi-tenancy, and custom visualizations. ([#8966](https://github.com/wazuh/wazuh-documentation/pull/8966))
