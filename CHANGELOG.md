...
- Updated the *Wazuh dashboard* documentation in *User manual*, including the redesigned Overview dashboard and the expanded Active Response configuration workflow. ([#9688](https://github.com/wazuh/wazuh-documentation/pull/9688)) ([#10033](https://github.com/wazuh/wazuh-documentation/pull/10033))
...
- Updated the *Log data collection* capability documentation to Wazuh 5.0, covering Wazuh agent configuration, collecting logs from files and operating systems, log data analysis, and new use cases. ([#10034](https://github.com/wazuh/wazuh-documentation/pull/10034))
