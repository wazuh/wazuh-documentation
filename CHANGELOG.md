...
- Added information about filters in the Windows agent to block UNC and mapped drive paths to mitigate *NetNTLMv2* vulnerabilities. ([#8623](https://github.com/wazuh/wazuh-documentation/pull/8623))
