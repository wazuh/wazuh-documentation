...
- Fixed the *Quickstart* card height on the documentation index page. ([#9818](https://github.com/wazuh/wazuh-documentation/pull/9818))
...
- Updated the *Vulnerability detection* capability documentation. ([#9835](https://github.com/wazuh/wazuh-documentation/pull/9835))
