...
- Updated the *Using Wazuh for GDPR compliance* documentation in *Regulatory compliance* to Wazuh 5.0. ([#TBD](https://github.com/wazuh/wazuh-documentation/pull/TBD))
