...
- **Post-release**: Fixed incorrect URL in the YARA download step of the *Leveraging LLMs for Alert Enrichment* PoC. ([#8686](https://github.com/wazuh/wazuh-documentation/pull/8686))
