...
- Changed the *Package list* title to *Open Virtual Appliances* in the *Virtual Machine (OVA)* section. ([#8513](https://github.com/wazuh/wazuh-documentation/pull/8513))
