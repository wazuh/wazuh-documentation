...
- **Post-release**: Fixed mismatched screenshot titles in the *Proof of concept guide* and *Active Response* documentation, and corrected a false version-support claim and a URL-breaking formatting issue in `llms.txt`. ([#10158](https://github.com/wazuh/wazuh-documentation/pull/10158))
